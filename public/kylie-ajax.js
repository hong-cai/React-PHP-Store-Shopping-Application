...
var ajaxCart = (function (module, $) {
    ...
    cartUpdateCallback = function (cart) {
        ...
        buildCart(cart);
        addDiscountEvents(cart);
    };

    var addDiscountEvents = function (cart) {
        //discount cart suport with dtag
        //Register to dcode changes  only if its enabled (terru)
        var $container = document.querySelector('#discount-code');

        if ($container) {
            //generates an observer for changes in the footer
            MutationObserver = window.MutationObserver || window.WebKitMutationObserver;
            var observer = new MutationObserver(function (mutations) {
                var discountBox = $(".dcDiscountBox");
    ...
    cartCallback = function (cart) {
        ...
        } else if (window.freeGiftFromPrice) {
            console.warn('Cart Callback, Free Gift From PRice');
